 ...
 * 
 * @file hw_config.cpp
 * @brief This file contains all neccessary functions to init and use HAL libs.
 * 
 * 
...
#include "hal_stm32f1xx_hal_conf.h"
#include "hal_stm32f1xx_it.h"
#include "hal_dma.h"
...
/**
  * @brief  Perform all actions needed to configure uC clock and HAL.
  */
void hal_config()
{
